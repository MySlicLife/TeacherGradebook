...
class _YearLandingPageState extends State<YearLandingPage>
  ...
  final List<int> flexValuesMainColumn = [2, 1, 1, 1, 1];
  final List<int> flexValuesLeftColumn = [2, 6];
  final List<int> flexValuesRightColumn = [];
                                      ...
                                      children: [
                                        ...
                                        TabBar(
                                          ...
                                          dividerColor: welcomeThemeState
                                              .colorScheme.primary,
                                          dividerHeight: 5,
                                          indicatorColor: welcomeThemeState
                                              .colorScheme.surface,
                                          ...
                                          child: TabBarView(
                                            ...
                                            children: decades.map((decade) {
                                              return GridView.builder(
                                                ...
                                                itemCount: groupedYears[decade]
                                                        ?.length ??
                                                    0,
                                                itemBuilder: (context, index) {
                                                  final year = groupedYears[
                                                      decade]![index];
                                                  return Padding(
                                                    padding:
                                                        const EdgeInsets.all(
                                  ...
                                  SizedBox(
                                    ...
                                    child: NeumorphicIconButton(
                                      onPressed: () {
                                        ...
                                        setState(() {
                                          selectedYearTheme = getCurrentTheme(selectedYear != null ? selectedYear!.yearColorId : addYearColor ?? widget.mainAppThemeId, themeCubit,
                                          );
                                        });
                                      },
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: selectedYearTheme?.colorScheme.primary ??
                                  welcomeThemeState.colorScheme.primary,
                            ),
                            child: Column(
                              ...
                              children: [
                                ...
                                Flexible(
                                  ...
                                  child: NeumorphicTextField(
                                    ...
                                    hintText: yearTextController.text.isNotEmpty
                                        ? yearTextController.text
                                        : "Year",
                                    textController: yearTextController,
                                    screenTheme:
                                        selectedYearTheme ?? welcomeThemeState,
                                    fontSize: 80,
                                    cursorHeight: 75,
                                  ),
                                ),
                                      ...
                                      Flexible(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontSize:
                                                  50, // Increase font size for the large dash
                                              color: selectedYearTheme
                                                      ?.colorScheme
                                                      .onTertiary ??
                                                  welcomeThemeState
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        addYear ? 'Temporary | 100' : "${selectedItemStatistics['max']['student']} | ${selectedItemStatistics['max']['grade']}",
                                                        style: TextStyle(
                                                          color: selectedYearTheme
                                                                  ?.colorScheme
                                                                  .onSecondary ??
                                                      ...
                                                      Text(
                                                        addYear
                                                            ? 'Temporary | 50'
                                                            : "${selectedItemStatistics['min']['student']} | ${selectedItemStatistics['min']['grade']}",
                                                        style: TextStyle(
                                                          color: selectedYearTheme
                                                                  ?.colorScheme
                                                                  .onSecondary ??
