...
class _YearLandingPageState extends State<YearLandingPage>
  ...
  Map<String, List<Year>> groupYearsByDecade(List<Year> years) {
    ...
    for (var year in years) {
      String key = '${year.year.toString().substring(0, 3)}0s'; // Example: 2020s
    ...
    if (pickedDate != null) {
      setState(() {
        if (calendarNumber == 1) {
          ...
          if (selectedEndDate != null && pickedDate.isBefore(selectedStartDate!)) {
                        ...
                        Flexible(
                          ...
                          child: Align(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text("Welcome back ${widget.teacherName}!",
                                  style: TextStyle(
                                    fontSize: 45,
                                    color: welcomeThemeState.colorScheme.onSurface,
                                  ),
                                ),
                                Text("Please select a year below..",
                                  style: TextStyle(
                                    fontSize: 30,
                                    color: welcomeThemeState.colorScheme.onSurface,
                                  ),
                          ...
                          child: BlocBuilder<YearCubit, YearState>(
                            builder: (context, yearState) {
                              if (yearState is YearsLoading) {
                                ...
                                groupedYears = groupYearsByDecade(yearState.schoolYears);
                                ...
                                return Center(
                                    child: Text("Error loading years! $yearState"));
                              }
                            },
                          ),
                        ),
                                            ...
                                            onPressed: () {
                                              ...
                                              setState(() {
                                                selectedYearTheme = getCurrentTheme(
                                                    selectedYear != null ? selectedYear!.yearColorId : addYearColor ?? widget.mainAppThemeId, themeCubit);
                                              });
                                            },
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    ...
                                    child: Row(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.center, // Center vertically for all children
                                      children: [
                                          ...
                                          child: GestureDetector(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(
                                                  child: Text(
                                                    selectedStartDate == null ? "Select Start Date" : DateFormat('MMMM dd, yyyy').format(selectedStartDate!),
                                                    style: TextStyle(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(
                                                  child: Text(
                                                    selectedEndDate == null ? "Select End Date" : DateFormat('MMMM dd, yyyy').format(selectedEndDate!),
                                                    style: TextStyle(
                                                      color: selectedYearTheme?.colorScheme.onTertiary ?? welcomeThemeState.colorScheme.onTertiary,
                                                      fontSize: 22,
                                                    ),
                                  ...
                                  Flexible(
                                    flex: 1,
                                    child: BlocProvider(
                                      create: (context) => CourseCubit(TeacherRepo()),
                                        ...
                                        Row(
                                          children: [
                                              ...
                                              child: NeumorphicTextButton(
                                                ...
                                                onPressed: () {
                                                  if (addYear == true) {
                                                    ...
                                                    yearCubit.deleteYear(selectedYear!.id);
                                                    setState(() {
                                                      selectedYear = null;
                                                      selectedYearTheme = null;
                                                      selectedCourseList = null;
                                            ...
                                            SizedBox(
                                                ...
                                                child: GestureDetector(
                                                  onTap: () async {
                                                    await _openColorPicker(selectedYear);
                                                    setState(() {
                                                      selectedYearTheme = getCurrentTheme(selectedYear?.yearColorId ?? addYearColor!,themeCubit);
                                                    });
                                                  },
                                                  child: Container(
                                                    decoration: BoxDecoration(
                                              ...
                                              if (addYear == true) {
                                                  ...
                                                  child: NeumorphicTextButton(
                                                    ...
                                                    onPressed: () {
                                                      ...
                                                      if (yearState.schoolYears.any((year) => year.year != yearTextController.text)) {
                                                        ...
                                                        ScaffoldMessenger.of(context).showSnackBar(
                                                          SnackBar(
                                                            content: Text("This year already exists",
                                                              style: TextStyle(
                                                                  color: selectedYearTheme?.colorScheme.onError ?? welcomeThemeState.colorScheme.onError),
                                                            ),
                                                ...
                                                return Row(
                                                  children: [
                                                    ...
                                                    if (textChanged == true || colorChanged == true ||  selectedStartDate != schoolYearFromState.startDate || selectedEndDate != schoolYearFromState.endDate)
                                                      SizedBox(
                                                        width: 125,
                                                        child: NeumorphicTextButton(
